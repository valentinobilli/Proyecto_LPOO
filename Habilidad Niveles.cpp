...
int Nivel = 0;
string Poder[8] = {"Ninguna habilidad","Nivel 1: Elimina un espacio", "Nivel 2: Elimina 3 espacios juntos en una fila", "Nivel 3: Elimina un 3x3 utilizando como centro el espacio seleccionado", "Nivel 4: Elimina una fila completa", "Nivel 5: Elimina 3 filas juntas, usando como centro la fila del espacio seleccionado", "Nivel 6: Elimina 5 filas juntas, usando como centro la fila del espacio seleccionado", "Nivel 7: Borra todo el tablero"};
